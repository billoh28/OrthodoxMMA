...
def predict(video_path, class_name, out_video_path, file_location):
...
def main():
  # Example call: python mediapipe_classification.py "C:\Users\ohanl\Documents\CA400-Project\CA400-videos\Kick\Test\testing_1.mp4" "C:\Users\ohanl\Documents\CA400-Project\CA400-videos\Kick"

  # get file location off of cmdline
  video_path = sys.argv[1] # video to be predicted
  file_location = sys.argv[2] # location of dataset csv

  class_name = "kick_up"

  out_video_path = "test_1_results.mp4"

  predict(video_path, class_name, out_video_path, file_location)
